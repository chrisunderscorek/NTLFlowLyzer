        ...
        with warnings.catch_warnings():
            ...
            for flow in flows:
                ...
                for feature in self.__features:
                    ...
                    try:
                        # UDP flows intentionally keep the original output
                        # schema. Features that require TCP handshake state,
                        # TCP flags, or TCP window sizes are not meaningful for
                        # UDP, so emit NaN instead of logging one exception per
                        # feature and flow.
